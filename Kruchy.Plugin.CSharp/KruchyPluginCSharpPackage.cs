...
namespace Kruchy.Plugin.CSharp
{
    ...
    [Guid(KruchyPluginCSharpPackage.PackageGuidString)]
    ...
    public sealed class KruchyPluginCSharpPackage : Package
    {
        ...
        /// </summary>
        public const string PackageGuidString = "acccf1f2-dcf2-4fdc-b769-32c45ddefbcb";

        /// <summary>
        /// Initializes a new instance of the <see cref="FirstCommand"/> class.
        /// </summary>
        public KruchyPluginCSharpPackage()
        {
